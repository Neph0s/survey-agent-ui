...
<div class="group relative my-4 rounded-lg">
	...
	<pre
		class="scrollbar-custom overflow-auto whitespace-pre-wrap px-5 scrollbar-thumb-gray-500 hover:scrollbar-thumb-gray-400 dark:scrollbar-thumb-white/10 dark:hover:scrollbar-thumb-white/20"><code
